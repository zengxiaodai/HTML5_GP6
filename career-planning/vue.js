// 手写简易Vue：https://www.jianshu.com/p/4b3ba372a233
// 观察者模式：https://www.jianshu.com/p/44c71cd38767
// 策略模式：https://www.jianshu.com/p/32ddbf6e87b2
// 渲染器源码解析：http://hcysun.me/vue-design/zh/

// Vue，构造函数，组件实例化
// Observer，实现依赖收集
// Dep，消息系统，notify()，这是真正的观察者
// Compiler，是vue指令的编译器
// Watcher，是用于更新视图
...
class Compiler { // 解析指令, 编译模板
  ...
  static compileUtil = { // 解析指令的对象
    ...
    text(node, key, vm) { // 编译v-text指令的方法
      ...
      new Watcher(vm, key, newVal => { // 接受callback执行时第一个参数
